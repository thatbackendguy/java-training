    ...
    public static void main(String[] args) throws Exception {
        try (ZContext context = new ZContext()) {
            ...
            for (int i = 0; i < 10000; i++) {
                ...
                if(msg1.equals("Received at PUB1"))
                {
                    pub2.send("Message " + i + " from pub2");
                    byte[] pull2Ack = pull2.recv(0);
                    String msg2 = new String(pull2Ack);
                    System.out.println(msg2);

                    if(msg2.equals("Received at PUB2"))
                    {
                        pub3.send("Message " + i + " from pub3");
                        byte[] pull3Ack = pull3.recv(0);
